...
class Home extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(...args) {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "fetchData", async e => {
      ...
      try {
        console.log("Data.");
        const data = await _api__WEBPACK_IMPORTED_MODULE_4__["default"].summoner.general(this.props.match.params.summonerName);
        console.log("No se");
        console.log(data);
        this.setState({
          loading: false,
  ...
  componentDidMount() {
    console.log("dogijdfogidfjgiofdjgio");
...
//# sourceMappingURL=summoner.js.a72fbcd90e4cc7faa4e2.hot-update.js.map