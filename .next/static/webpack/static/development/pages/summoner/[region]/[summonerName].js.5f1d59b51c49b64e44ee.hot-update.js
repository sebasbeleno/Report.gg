...
/***/ "./src/images lazy recursive ^\\.\\/Emblem_.*\\.png$":
/*!***************************************************************!*\
  !*** ./src/images lazy ^\.\/Emblem_.*\.png$ namespace object ***!
  \***************************************************************/
...
var map = {
	"./Emblem_Bronze.png": [
		"./src/images/Emblem_Bronze.png",
		1
	],
	"./Emblem_Challenger.png": [
		"./src/images/Emblem_Challenger.png",
		2
	],
	"./Emblem_Diamond.png": [
		"./src/images/Emblem_Diamond.png",
		3
	],
	"./Emblem_Gold.png": [
		"./src/images/Emblem_Gold.png",
		4
	],
	"./Emblem_Grandmaster.png": [
		"./src/images/Emblem_Grandmaster.png",
		5
	],
	"./Emblem_Iron.png": [
		"./src/images/Emblem_Iron.png",
		6
	],
	"./Emblem_Master.png": [
		"./src/images/Emblem_Master.png",
		7
	],
	"./Emblem_Platinum.png": [
		"./src/images/Emblem_Platinum.png",
		8
	],
	"./Emblem_Silver.png": [
...
webpackAsyncContext.id = "./src/images lazy recursive ^\\.\\/Emblem_.*\\.png$";
...
class Home extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(...args) {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "loadImage", imageName => {
      __webpack_require__("./src/images lazy recursive ^\\.\\/Emblem_.*\\.png$")("./Emblem_".concat(this.state.summoner.ranked_solo_fives.tier, ".png")).then(image => {
        this.setState({
          image
        });
      });
...
//# sourceMappingURL=[summonerName].js.5f1d59b51c49b64e44ee.hot-update.js.map