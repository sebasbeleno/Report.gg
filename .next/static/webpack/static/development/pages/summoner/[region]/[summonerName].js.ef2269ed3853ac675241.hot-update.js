...
/***/ "./src/pages/summoner/[region] sync recursive ^.*$":
/*!***********************************************!*\
  !*** ./src/pages/summoner/[region] sync ^.*$ ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var map = {
	"./[summonerName]": "./src/pages/summoner/[region]/[summonerName].js",
	"./[summonerName].js": "./src/pages/summoner/[region]/[summonerName].js"
};
...
webpackContext.id = "./src/pages/summoner/[region] sync recursive ^.*$";
...
class Home extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(...args) {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "fetchData", async e => {
      ...
      try {
        ...
        this.setState({
          emblem: "../../../images/Emblem_".concat(this.state.summoner.ranked_solo_fives.tier, ".png")
        });
        console.log(this.state.emblem);
        this.setState({
          loading: false
        });
  ...
  render() {
    ...
    return __jsx("div", {
      ...
      src: __webpack_require__("./src/pages/summoner/[region] sync recursive ^.*$")("".concat(this.state.emblem)),
      __self: this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 107,
...
//# sourceMappingURL=[summonerName].js.ef2269ed3853ac675241.hot-update.js.map