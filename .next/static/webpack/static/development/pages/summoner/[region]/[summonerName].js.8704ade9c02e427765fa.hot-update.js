  ...
  constructor(...args) {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "fetchData", async e => {
      ...
      try {
        ...
        this.loadImage(toString(this.state.summoner.ranked_solo_fives.tier));
        this.setState({
          loading: false,
          summoner: data
        });
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "loadImage", imageName => {
      __webpack_require__("./src/images/ranked-emblems lazy recursive ^\\.\\/.*\\.png$")("./".concat(this.state.summoner.ranked_solo_fives.tier, ".png")).then(image => {
        this.setState({
          image
        });
      });
...
//# sourceMappingURL=[summonerName].js.8704ade9c02e427765fa.hot-update.js.map