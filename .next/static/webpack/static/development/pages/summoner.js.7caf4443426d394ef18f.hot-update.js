...
class Home extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(...args) {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "fetchData", async e => {
      ...
      try {
        console.log("Data.");
        const data = await _api__WEBPACK_IMPORTED_MODULE_4__["default"].summoner.general(this.urlParams.region, this.urlParams.summonerName);
        console.log("No se");
        console.log(data);
        this.setState({
          loading: false,
...
//# sourceMappingURL=summoner.js.7caf4443426d394ef18f.hot-update.js.map