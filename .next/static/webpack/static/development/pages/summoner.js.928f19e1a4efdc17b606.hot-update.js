...
class Home extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(...args) {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "fetchData", async e => {
      ...
      try {
        console.log("Data.");
        const data = await _api__WEBPACK_IMPORTED_MODULE_4__["default"].summoner.general(this.urlParams.region, this.urlParams.summoner);
        console.log("No se");
        console.log(data);
        this.setState({
          loading: false,
...
//# sourceMappingURL=summoner.js.928f19e1a4efdc17b606.hot-update.js.map